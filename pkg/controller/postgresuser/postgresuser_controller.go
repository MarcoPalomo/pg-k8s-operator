...
import (
	...
	"github.com/MarcoPalomo/pg-k8s-operator/pkg/config"

	"github.com/go-logr/logr"
	dbv1alpha1 "github.com/MarcoPalomo/pg-k8s-operator/pkg/apis/db/v1alpha1"
	"github.com/MarcoPalomo/pg-k8s-operator/pkg/postgres"
	"github.com/MarcoPalomo/pg-k8s-operator/pkg/utils"
...
func (r *ReconcilePostgresUser) addFinalizer(reqLogger logr.Logger, m *dbv1alpha1.PostgresUser) error {
	if len(m.GetFinalizers()) < 1 && m.GetDeletionTimestamp() == nil {
		...
		m.SetFinalizers([]string{"finalizer.db.pgk8s.com"})
